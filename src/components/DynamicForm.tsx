'use client';
import { great_vibes } from '@/pages/_app';
  ...
  return (
    <div className = 'border p-6 mt-6 rounded-lg w-[600px] bg-yellow-200'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <div className="mb-2">
          <label className="me-4 font-lobster" htmlFor="zipCode">
            Zip Code
          </label>
          <input
            type="text"
        ...
        <div className="mb-2">
          <label className="me-4 font-lobster" htmlFor="state">
            State:
          </label>
          <select
            id="state"
        ...
        <div className="mb-2">
          <label className="me-4" htmlFor="country">
            Country:
          </label>
          <select
            id="country"
